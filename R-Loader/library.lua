return function(ctx)
    ...
    local create = ctx.create
    local roundify = ctx.roundify
    local addStroke = ctx.addStroke
    local tween = ctx.tween
    local ScreenGui = ctx.ScreenGui
    local SimplifyAnimations = ctx.SimplifyAnimations
    local PinnedTabs = ctx.PinnedTabs
    local TweenService = ctx.TweenService
    local UserInputService = ctx.UserInputService
    local Header_Image = ctx.Header_Image

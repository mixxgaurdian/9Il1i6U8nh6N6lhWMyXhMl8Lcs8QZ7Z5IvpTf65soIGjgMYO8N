...
local DEFAULT_CARD_ICON = "rbxassetid://10723396818" -- You can replace this ID/URL with whatever image you want
...
-- // DEFINE YOUR CUSTOM DEFAULT ICON HERE //
    local Default_icon = "https://raw.githubusercontent.com/mixxgaurdian/9Il1i6U8nh6N6lhWMyXhMl8Lcs8QZ7Z5IvpTf65soIGjgMYO8N/refs/heads/main/Image/Icons/R-loadertrans-Christmas.png"

    -- Determine the image to use
    local finalImageURL
    if scriptImageURL and scriptImageURL ~= "" then
        -- If a specific image exists, use it
        finalImageURL = scriptImageURL 
    else
        -- If the field is empty or nil, use your Christmas Default Icon
        finalImageURL = Default_icon
    end
